  ...
  return (
    <div className={`relative w-[338px] h-[223px] ${className}`}>
      <div className="absolute w-[208px] h-[88px] -top-px left-[61px]">
        ...
        <div className="absolute w-[208px] h-[44px] top-[44px] left-0 [font-family:'Inria_Serif',Helvetica] font-light text-[#342f19] text-[24px] text-center tracking-[0] leading-[normal]">
          {text1}
        </div>
      </div>
      <p className="absolute w-[281px] h-[80px] top-[142px] left-[17px] [font-family:'Inter',Helvetica] font-thin text-black text-[18px] text-center tracking-[0] leading-[normal]">
        {text2}
      </p>
    </div>
  );
