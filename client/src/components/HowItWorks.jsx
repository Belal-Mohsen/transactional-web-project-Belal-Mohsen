...
const HowItWorks = () => {
  return (
    <div className="bg-[#f7f6f2] rounded-[10px] text-center py-8 mb-8">
      <h2 className="font-bold [font-family:'Inria_Serif',Helvetica] text-[#7d5844] text-[34px]">How It Works</h2>
      ...
      <Link to="/subscribe" className="text-[#c0876a] text-[16px]  [font-family:'Inria_Serif',Helvetica] border-2 border-solid border-[#c0876a] font-bold py-2 px-2 rounded-[5px] mr-10">
          GET STARTED
        </Link>
        <Link to="/faq" className="text-[#c0876a] text-[16px]  [font-family:'Inria_Serif',Helvetica]  border-2 border-solid border-[#c0876a] font-bold py-2 px-2 rounded-[5px] ml-10">
